...
<img src="autoGenerate.png" class="img-responsive" alt="" width="300" height="300">

- **Voice to text** - Easy to use only your voice to write your texts
<img src="speechToText.png" class="img-responsive" alt="" width="300" height="300">

- **Document files** - Save your document as .tex (LaTeX), .PDF or as SmartNots own format, .note
<img src="saveSmartNotes.png" class="img-responsive" alt="" width="300" height="300">
